...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_REWARD_SEESAW_ENFORCEMENT) r = SPORK_18_REWARD_SEESAW_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_REWARD_SEESAW_ENFORCEMENT") return SPORK_18_REWARD_SEESAW_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_REWARD_SEESAW_ENFORCEMENT) return "SPORK_18_REWARD_SEESAW_ENFORCEMENT";
