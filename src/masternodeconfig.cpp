    ...
    if (!streamConfig.good()) {
        ...
        if (configFile != NULL) {
            std::string strHeader = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:22100 5exBfUUcYmNAXeyeSnbWbAkiWYvsVdmDPSac68dj8yQoroG5GFK 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
...
void CMasternodeConfig::writeToMasternodeConf()
{
    ...
    std::string strHeader = "# Masternode config file\n"
                            "# Format: alias IP:port masternodeprivkey collateral_output_txid collateral_output_index\n"
                            "# Example: mn1 127.0.0.2:11771 5exBfUUcYmNAXeyeSnbWbAkiWYvsVdmDPSac68dj8yQoroG5GFK 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
    fwrite(strHeader.c_str(), std::strlen(strHeader.c_str()), 1, configFile);
